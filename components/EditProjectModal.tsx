...
export const EditProjectModal: React.FC<EditProjectModalProps> = ({ project, onClose }) => {
    ...
    const [formData, setFormData] = useState({
        ...
        overallDeadline: format(parseISO(project.overallDeadline), 'yyyy-MM-dd')
    });
    ...
    const modalContent = (
        <div className="fixed inset-0 bg-slate-900/70 backdrop-blur-md z-[10000] flex items-center justify-center p-4 animate-saas-fade">
            <div
            ...
            >
                <div className="flex items-center justify-between px-8 py-6 border-b border-slate-100 dark:border-slate-700">
                    <div>
                        <h2 className="text-2xl font-black text-slate-900 dark:text-slate-100">Edit Project Details</h2>
                        <p className="text-slate-500 dark:text-slate-400 text-sm font-medium">Update core project information.</p>
                    </div>
                    <button
                        onClick={onClose}
                ...
                <div className="p-8 max-h-[calc(90vh-120px)] overflow-y-auto">
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div>
                            <label className="block text-xs font-bold text-slate-400 dark:text-slate-500 uppercase tracking-widest mb-1">
                                Overall Deadline <span className="text-red-500">*</span>
                            </label>
                            <div className="relative">
